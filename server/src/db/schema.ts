...
export const bloodworkReports = sqliteTable(
	'bloodwork_reports',
	{
		...
		importLocationIsInferred: integer('import_location_is_inferred', { mode: 'boolean' })
			.notNull()
			.default(false),
...
export const bloodworkMarkers = sqliteTable(
	'bloodwork_markers',
	{
		id: integer('id').primaryKey({ autoIncrement: true }),
...
export const bloodworkResults = sqliteTable(
	'bloodwork_results',
	{
		...
		markerId: integer('marker_id')
			.notNull()
			.references(() => bloodworkMarkers.id, { onDelete: 'cascade' }),
...
export const bloodworkMergedSources = sqliteTable(
	'bloodwork_merged_sources',
	{
		id: integer('id').primaryKey({ autoIncrement: true }),
		reportId: integer('report_id')
			.notNull()
	...
	table => [index('bloodwork_merged_sources_report_sort_idx').on(table.reportId, table.sortOrder)],
);

export const bloodworkResultDuplicates = sqliteTable(
	'bloodwork_result_duplicates',
	{
		id: integer('id').primaryKey({ autoIncrement: true }),
		resultId: integer('result_id')
			.notNull()
			.references(() => bloodworkResults.id, { onDelete: 'cascade' }),
		sortOrder: integer('sort_order').notNull(),
		date: text('date').notNull(),
		valueText: text('value_text'),
		valueNumeric: real('value_numeric'),
...
export const bloodworkResultProvenance = sqliteTable(
	'bloodwork_result_provenance',
	{
		id: integer('id').primaryKey({ autoIncrement: true }),
		resultId: integer('result_id')
			.notNull()
...
export const bloodworkImportReviews = sqliteTable(
	'bloodwork_import_reviews',
	{
		id: integer('id').primaryKey({ autoIncrement: true }),
...
export const bloodworkResultDuplicatesRelations = relations(
...
export const bloodworkResultProvenanceRelations = relations(
